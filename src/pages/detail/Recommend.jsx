...
import { useMovieByRecommendationQuery } from "../../features/movieApi";
...
const Recommend = ({ movieId }) => {
  ...
  const { data, isLoading, isError, error, isFetching } =
    useMovieByRecommendationQuery(movieId);
  ...
  return (
    <div className="pb-[20px]">
      <ContentWrapper>
        {movieId && (
          <div className="text-[24px] font-[600] py-5">Recommended Movies:</div>
        )}
        {!isLoading ? (
          <>
